...
urlpatterns = [
    ...
    # Chat
    path('groups/<int:group_id>/chat/send/', views.send_chat_message, name='send_chat_message'),
    path('groups/<int:group_id>/chat/messages/', views.get_chat_messages, name='get_chat_messages'),
    
    # Reports
    path('groups/<int:group_id>/report/generate/', views.generate_impact_report, name='generate_impact_report'),
